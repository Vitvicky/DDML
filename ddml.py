...
if __name__ == '__main__':
    ...
    logger.info("Similar: Total: %d, Purity: %.3f, Average Distance: %.6f", similar_total, similar_correct / similar_total, similar_dist_sum / similar_total)
    logger.info("Dissimilar: Total: %d, Purity: %.3f, Average Distance: %.6f", dissimilar_total, dissimilar_correct / dissimilar_total, dissimilar_dist_sum / dissimilar_total)
